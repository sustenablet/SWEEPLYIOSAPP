...
#ifndef SWEEPLY_SWIFT_H
#define SWEEPLY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SWEEPLY",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7SWEEPLY22AddressSearchViewModel")
@interface AddressSearchViewModel : NSObject <MKLocalSearchCompleterDelegate>
...
SWIFT_CLASS("_TtC7SWEEPLY11AppDelegate")
...
SWIFT_CLASS("_TtC7SWEEPLY15LocationManager")
...
@class CLLocation;
@interface LocationManager (SWIFT_EXTENSION(SWEEPLY)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC7SWEEPLY19NotificationManager")
