                    ...
                    VStack(spacing: 10) {
                        ...
                        HStack(spacing: 12) {
                            Image(systemName: "person")
                                ...
                                .foregroundStyle(Color.sweeplyTextSub)
                                .frame(width: 24)
                            TextField("Their name".translated(), text: $teamInviteName)
                                .font(.system(size: 16))
                                .foregroundStyle(Color.sweeplyNavy)
                        ...
                        HStack(spacing: 10) {
                            HStack(spacing: 12) {
                                Image(systemName: "envelope")
                                    ...
                                    .foregroundStyle(Color.sweeplyTextSub)
                                    .frame(width: 24)
                                TextField("Email address".translated(), text: $teamInviteEmail)
                                    .font(.system(size: 16))
                                    .foregroundStyle(Color.sweeplyNavy)
                                    .keyboardType(.emailAddress)
                                    .textInputAutocapitalization(.never)
            ...
            VStack(spacing: 20) {
                VStack(alignment: .leading, spacing: 8) {
                    Text("Service Name".translated())
                        .font(.system(size: 12, weight: .semibold))
                        .foregroundStyle(Color.sweeplyTextSub)
                    TextField("e.g. Carpet Cleaning".translated(), text: $name)
                        .font(.system(size: 17))
                        .padding(14)
                        .background(Color.sweeplyBackground)
